                  ...
                  <div class="summary">
                    <div class="summary-item">
                     ...
                     System.out.println(i+1+"번째 bouList");%>   
                        <li class="media">
                          <a href="StockInfo.jsp">
                            <img class="mr-3 rounded" width="50" src="../assets/img/posco.png" alt="product">
                          </a>
                          <div class="media-body">
                          	<%
                            	String jongmokcode = bouList.get(i).getJongmokCode();
                            	JugadataDAO dao3 = new JugadataDAO();
                            	JugadataDTO juga = dao3.find("A029780");
                            	int StockC_Price =  Integer.parseInt(bouList.get(i).getBouJu());
                            	double minus = ((double)juga.getClosePrice() - (double)StockC_Price)/(double)StockC_Price;
                            	DecimalFormat form = new DecimalFormat("#.##");
                            %>
                            <div class="media-right"><%=juga.getClosePrice()%>원</div>
                            <div class="media-title"><a id="jongmok" href="StockInfo.jsp"><%=jongmokcode%></a></div>
                            <div class="text-muted text-small"><%=bouList.get(i).getStockC_Price()%>주<div class="bullet">
                            </div>
              ...
              <div class="card">
                ...
                <div class="card card-statistic-2">
                  <div class="card-stats">
                    ...
                    <div class="card-wrap">
                      <div class="card-header">
                      <div class="text-muted text-small"><span class="text-primary"><!--  <i class="fas fa-caret-down">--></i></span>부도율 매우 안전</div>
                      </div>
                      <div class="card-body">
                        네이버
                      </div>
                  ...
                  <div class="card-wrap">
                    <div class="card-header">
                      <div class="text-muted text-small"><span class="text-danger"><!-- <i class="fas fa-caret-up">--></i></span>부도율 안전</div>
                    </div>
                    <div class="card-body">
                      포스코
                    </div>
...
<!--                   <div class="card-icon shadow-primary bg-primary">
  ...
  $("a#jongmok").click(function(){
	  var name = $(this).text();
	  $(this).attr("href", "StockInfo.jsp?jongmokname="+name);
  });
